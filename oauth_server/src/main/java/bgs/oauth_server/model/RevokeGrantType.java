...
public class RevokeGrantType {
    ...
    public boolean revokeGrantType(Integer clientID, String authCode) throws ResponseStatusException {
        ...
        AuthCode authCodeFound = codesFromDataBase.stream().filter(c -> authCode.equals(c.getContent()) && clientID.equals(c.getClientApp().getClientAppId())).findFirst().orElse(null);
